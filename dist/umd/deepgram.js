    ...
    var e = {
        ...
        98: function (e, t) {
          ...
          !(function (e) {
            !(function (t) {
              ...
              (O.polyfill = !0),
                e.fetch || ((e.fetch = O), (e.Headers = d), (e.Request = b), (e.Response = _)),
                (t.Headers = d),
                (t.Request = b),
                (t.Response = _),
                (t.fetch = O),
        ...
        274: (e, t, r) => {
          ...
          const n = r(752),
            ...
            c = r(693),
            u = r(733);
          class l extends i.AbstractClient {
            get listen() {
            ...
            get speak() {
              return new u.SpeakClient(this.key, this.options);
            }
            get transcription() {
        ...
        716: function (e, t, r) {
          ...
          (t.resolveFetch = (e) => {
            let t;
            return (t = e || ("undefined" == typeof fetch ? c.default : fetch)), (...e) => t(...e);
          }),
            (t.fetchWithAuth = (e, r) => {
              const n = (0, t.resolveFetch)(r),
                i = (0, u.resolveHeadersConstructor)();
              return (t, r) =>
                o(void 0, void 0, void 0, function* () {
                  let s = new i(null == r ? void 0 : r.headers);
                  return (
                    s.has("Authorization") || s.set("Authorization", `Token ${e}`),
                    n(t, Object.assign(Object.assign({}, r), { headers: s }))
                  );
                });
            }),
            (t.resolveResponse = () =>
        ...
        207: function (e, t, r) {
          ...
          class c extends o.AbstractClient {
            constructor(e, t) {
              ...
              this.fetch = (0, s.fetchWithAuth)(this.key, t._experimentalCustomFetch);
            }
            _getErrorMessage(e) {
        ...
        118: (e, t, r) => {
          ...
          const n = r(898),
            ...
            o = r(678),
            a = r(57);
          class c extends n.AbstractWsClient {
        ...
        412: function (e, t, r) {
          ...
          class a extends i.AbstractRestfulClient {
            getTokenDetails(e = "v1/auth/token") {
              return n(this, void 0, void 0, function* () {
                try {
        ...
        733: function (e, t, r) {
          ...
          Object.defineProperty(t, "__esModule", { value: !0 }), (t.SpeakClient = void 0);
          const i = r(207),
            s = r(752),
            o = r(610);
          class a extends i.AbstractRestfulClient {
            request(e, t, r = "v1/speak") {
              return n(this, void 0, void 0, function* () {
                try {
                  let n;
                  if (!(0, o.isTextSource)(e))
                    throw new s.DeepgramError("Unknown transcription source type");
                  n = JSON.stringify(e);
                  const i = Object.assign({ model: "aura-asteria-en" }, t),
                    a = new URL(r, this.baseUrl);
                  return (
                    (0, o.appendSearchParams)(a.searchParams, i),
                    (this.result = yield this._handleRawRequest(this.fetch, "POST", a, {}, {}, n)),
                    this
                  );
                } catch (e) {
                  throw e;
            ...
            getStream() {
              return n(this, void 0, void 0, function* () {
                if (!this.result)
                  throw new s.DeepgramUnknownError("Tried to get stream before making request", "");
